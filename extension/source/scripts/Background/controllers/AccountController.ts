...
export interface IAccountController {
  subscribeAccount: (HDsigner: any, block: string) => Promise<string | null>;
...
const AccountController = (actions: {
  ...
  const subscribeAccount = async (HDsigner: any, blockExplorer: string, label?: string) => {
    ...
    console.log(backendUrl, 'public key', account0.getAccountPublicKey(), 'hdsigner', HDsigner)
    console.dir(asset_information)
